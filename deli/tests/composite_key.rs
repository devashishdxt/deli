...
async fn test_value_add() {
    ...
    let id = store
        .add(&23, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
...
async fn test_value_update() {
    ...
    let id = store
        .add(&56, "Alice", "alice@example.com", &25)
        .await
        .unwrap();

    let update_id = store
        .update(&id.0, &id.1, "bob@example.com", &30)
        .await
        .unwrap();
...
async fn test_count() {
    ...
    let _id1 = store
        .add(&78, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let _id2 = store
        .add(&199, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
...
async fn test_get_all() {
    ...
    let id1 = store
        .add(&57, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store
        .add(&167, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
...
async fn test_get_all_keys() {
    ...
    let id1 = store
        .add(&67, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store.add(&67, "Bob", "bob@example.com", &30).await.unwrap();
...
async fn test_scan() {
    ...
    let id1 = store
        .add(&97, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store.add(&97, "Bob", "bob@example.com", &30).await.unwrap();
    ...
    if (forward_employees[0].id, forward_employees[0].name.clone()) == id1 {
        assert_eq!(
            (forward_employees[0].id, forward_employees[0].name.clone()),
            id1
        );
        ...
        assert_eq!(
            (backward_employees[0].id, backward_employees[0].name.clone()),
            id2
        );
...
async fn test_scan_keys() {
    ...
    let id1 = store
        .add(&867, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store
        .add(&978, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
...
async fn test_delete() {
    ...
    let id1 = store
        .add(&679, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store
        .add(&679, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
...
async fn test_unique_index() {
    ...
    store
        .add(&333, "Alice", "alice@example.com", &25)
        .await
        .unwrap();

    let err = store.add(&333, "Bob", "alice@example.com", &30).await;
...
async fn test_count_by_index() {
    ...
    store
        .add(&678, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    store
        .add(&678, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
    store
        .add(&678, "Charlie", "charlie@example.com", &35)
        .await
        .unwrap();
    store
        .add(&678, "Dave", "dave@example.com", &40)
        .await
        .unwrap();
...
async fn test_get_by_index() {
    ...
    let id1 = store
        .add(&788, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    let id2 = store
        .add(&788, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
    ...
    assert_eq!((employee1.id, employee1.name), id1);
    ...
    assert_eq!((employee2.id, employee2.name), id2);
...
async fn test_get_all_by_index() {
    ...
    let id1 = store
        ...
        .await
        .unwrap();
    let id2 = store.add(&89, "Bob", "bob@example.com", &30).await.unwrap();
    let id3 = store
        .add(&67, "Charlie", "charlie@example.com", &35)
        .await
        .unwrap();
    let id4 = store
        .add(&7, "Dave", "dave@example.com", &40)
        .await
        .unwrap();
    ...
    if (employees[0].id, employees[0].name.clone()) == id1 {
        assert_eq!((employees[1].id, employees[1].name.clone()), id2);
    } else {
        assert_eq!((employees[0].id, employees[0].name.clone()), id2);
        assert_eq!((employees[1].id, employees[1].name.clone()), id1);
    }
    ...
    assert_eq!((employees[0].id, employees[0].name.clone()), id3);
    ...
    assert_eq!(employees.len(), 1);
    assert_eq!((employees[0].id, employees[0].name.clone()), id4);
...
async fn test_get_all_keys_by_index() {
    ...
    let id2 = store
        ...
        .unwrap();
    let id3 = store
        .add(&6, "Charlie", "charlie@example.com", &35)
        .await
        .unwrap();
    let id4 = store
        .add(&8, "Dave", "dave@example.com", &40)
        .await
        .unwrap();
...
async fn test_scan_by_index() {
    ...
    let id4 = store
        .add(&7688, "Dave", "dave@example.com", &40)
        .await
        .unwrap();
    let id3 = store
        .add(&7688, "Charlie", "charlie@example.com", &35)
        .await
        .unwrap();
    let id2 = store
        .add(&7688, "Bob", "bob@example.com", &30)
        .await
        .unwrap();
    let id1 = store
        .add(&7688, "Alice", "alice@example.com", &25)
        .await
        .unwrap();
    ...
    assert_eq!((employees[0].id, employees[0].name.clone()), id1);
    assert_eq!((employees[1].id, employees[1].name.clone()), id2);
    ...
    assert_eq!((employees[0].id, employees[0].name.clone()), id4);
    assert_eq!((employees[1].id, employees[1].name.clone()), id3);
...
async fn test_scan_keys_by_index() {
    ...
    let id4 = store
        .add(&67, "Dave", "dave@example.com", &40)
        .await
        .unwrap();
    let id3 = store
        .add(&67, "Charlie", "charlie@example.com", &35)
